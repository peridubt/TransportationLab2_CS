namespace TransportationLab2
{
    ...
    */
    ...
    ВАЖНО: Ещё есть такой прикол, что паттерн наблюдателя на .NET можно реализовать с помощью событийной модели, 
    ...
    Мне лично всё равно, кто там что советует, потому что синтаксис собыйтий удобнее + не надо будет
